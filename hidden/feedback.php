...
$mailto = 'josh@joshuagraham.id.au' ;
$subject = "Feedback Form" ;
$formurl = "http://joshuagraham.id.au/hidden/contact.php" ;
$thankyouurl = "http://joshuagraham.id.au/thankyou.php" ;
$errorurl = "http://joshuagraham.id.au/404.php" ;
